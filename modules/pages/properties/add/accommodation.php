...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php require 'modules/pages/properties/add/form-accommodation.php'; ?>
   ...
   <script type="text/javascript">
    ...
    function modify_qty(val){
        var qty = document.getElementById('guestCapacity').value;
        var new_qty = parseInt(qty,10) + val;

        if(new_qty < 0){
            new_qty = 0;
        }
        document.getElementById('guestCapacity').value = new_qty;
        return new_qty;
    }

    function modify_bed(val){
        var bed_qty = document.getElementById('bedCapacity').value;
        var new_bed = parseInt(bed_qty,10) + val;

        if(new_bed < 0){
            new_bed = 0;
        }
        document.getElementById('bedCapacity').value = new_bed;
        return new_bed;
    }
