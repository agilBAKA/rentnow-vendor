...
<div class="header-table">
    ...
    <div class="header-table_action">
        ...
        <a href="add-accomodation.php" class="btn-primary">
        	Tambah Akomodasi
        </a>
    </div>
...
<div class="box-table table-2line table-properties">
	<table>
		<tr>
			<th>Rincian porduk</th>
			<th>Harga sewa</th>
			<th class="column-status">Status</th>
			<th class="column-action">tindakan</th>
		</tr>
		<tr>
			<td>
				<div class="box-item">
					<div class="images-item">
						<img src="dist/images/cover.jpeg" class="img-cover" alt="">
						<div class="overlay">
							5+
						</div>
					</div>
					<div class="info-item">
						...
						<span class="small-font">Apartemen - Ruangan pribadi</span>
					</div>
				</div>
			</td>
			<td>
			...
			<td class="column-action">
				<div class="box-action">
					<ul>
						...
						<li>
							<a href="" data-tooltip="Edit"><i class="zmdi zmdi-edit"></i></a>
						</li>
						<li>
		...
		<tr>
			<td>
				<div class="box-item">
					...
					<div class="info-item">
						<strong>Nama produk</strong>
						<span class="small-font">Rumah - Ruangan berbagi</span>
					</div>
				</div>
			</td>
			<td>
